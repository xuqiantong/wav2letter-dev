...
python forward_lm.py --model $TR --dict /checkpoint/wav2letter/released_models/sota/2019/lms/word_tr/dict.txt --text "/checkpoint/qiantong/wav2letter_experiments/decoder_sweep/beamdump/$1/$2.lst.hyp" --out "/checkpoint/qiantong/wav2letter_experiments/decoder_sweep/beamdump/$1/$2-tr.ppl" --model-type transformer --max-tokens 1024 --skip 1
